# app.py (Only Connection Details Changed)
...
import certifi # Needed for secure cloud connection
...
# --- 3. DATABASE CONNECTION & DATA LOADING (Corrected for TiDB Cloud) ---
@st.cache_resource
def create_db_engine():
    ...
    db_name = "ola_project"
    try:
        # Use the secure connection string for TiDB Cloud
...
def go_to_payment_completion(): st.session_state.page = 'Payment & Ride Completion'
...
# --- 6. EMBEDDED POWER BI DASHBOARD ---
st.markdown("---")
st.header("Embedded Interactive Power BI Report")
st.info("This is the full Power BI dashboard, published to the web and embedded here.")

# Paste the public link you copied from Power BI here
...
if power_bi_url != "https://app.powerbi.com/view?r=eyJrIjoiOTZiYTcxOTEtOTAxMC00OWEyLWFmODEtNzdhNDk1YzBjODA0IiwidCI6ImY4MDYwMTgxLWIxNzYtNDI5ZC05NGVlLWMzM2Y2N2FmOWRjMyJ9URL_HERE":
    st.components.v1.iframe(power_bi_url, height=800, scrolling=True)
else:
    st.warning("To embed the Power BI report, please paste the public URL into the app.py script.")
